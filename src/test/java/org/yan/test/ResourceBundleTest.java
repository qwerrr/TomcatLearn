...
public class ResourceBundleTest {
    public static void main(String[] args) {
        //测试默认
        ResourceBundle bundle = ResourceBundle.getBundle("org.yan.test.LocalStrings");
        ...
        ResourceBundle bundle_ja = ResourceBundle.getBundle("org.yan.test.LocalStrings", locale_ja);
        System.out.println("本地信息:"+bundle_ja.getLocale().toString());
        System.out.println("测试获取当前包内资源信息:"+bundle_ja.getString("abc"));


        Locale locale_en = new Locale("en");
        ResourceBundle bundle_en = ResourceBundle.getBundle("org.yan.test.LocalStrings", locale_en);
